...
class NewVsReturningCustomers extends BaseWidget
{

    // Public Properties
    // =========================================================================

    public static $displayName = 'New vs Returning Customers';
    ...
    public function getBodyHtml(): ?string
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            ...
            array_merge(
               ...
               CommerceWidgets::$plugin->customers->getNewVsReturningAnalytics($this->targetDuration, (int) $this->previousAmount)
            )
        );
    }
